...
-- CharacterAutoLoads was set to false in the place file so no one spawned
-- before the ground existed. Now turn it on and load everyone in.
Players.CharacterAutoLoads = true
for _, p in ipairs(Players:GetPlayers()) do
	p:LoadCharacter()
end

print("[Farm] World ready — spawning players.")
